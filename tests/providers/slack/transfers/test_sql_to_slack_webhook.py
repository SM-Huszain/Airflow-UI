...
class TestSqlToSlackWebhookOperator:
    ...
    def test_conflicting_conn_id(self):
        ...
        with pytest.raises(ValueError, match="Conflicting Connection ids provided"), pytest.warns(
            AirflowProviderDeprecationWarning, match="Parameter `slack_conn_id` is deprecated"
        ):
